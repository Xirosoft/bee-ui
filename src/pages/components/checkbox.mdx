...
<div className="form-check m-10">
    <input className="checkbox-primary checkbox" type="checkbox" defaultChecked />
    <input className="checkbox-secondary checkbox" type="checkbox" defaultChecked />
    <input className="checkbox-success checkbox" type="checkbox" defaultChecked />
    <input className="checkbox-info checkbox" type="checkbox" defaultChecked />
    <input className="checkbox-warning checkbox" type="checkbox" defaultChecked />
    <input className="checkbox-danger checkbox" type="checkbox" defaultChecked />
    <input className="checkbox-dark checkbox" type="checkbox" defaultChecked />
</div>
...
<div className="form-check m-10">
    <input className="checkbox" id="check01" type="checkbox" defaultChecked />
...
```html copy showLineNumbers
<div class="form-check m-10">
    <input class="checkbox" id="check01" type="checkbox" defaultChecked />
